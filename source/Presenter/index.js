...
var Presenter = (function () {
    function Presenter(view, model, block, options) {
        ...
        this.values = options.value.slice();
        ...
        this.values.forEach(function (it, idx) {
            var pin = new Pin_1["default"](_this.line.getDomElement(), it, options.pinUp);
